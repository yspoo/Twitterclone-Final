class AddUsernameToUsers < ActiveRecord::Migration[5.1]
  def change
    add_column  :users, :username,  :string,  null: false,  default: "" # add a new column to table "user", called "username" and of type "string". These values will all be in symbols. A symbol is an identifier for something that has an important meaning.
